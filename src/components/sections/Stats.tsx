...
export const Stats = () => {
  return (
    <section className="relative min-h-[70vh] md:h-screen flex items-center py-24 md:py-40 px-8 md:px-16 xl:pl-[160px] xl:pr-24 bg-[#F5F2ED] text-black font-serif snap-start">
