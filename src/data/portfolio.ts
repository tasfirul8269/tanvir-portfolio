export const portfolioData = {
  ...
  founderOf: "Frooxi",
  bio: "Senior-level frontend architect specializing in high-performance web applications and minimalist digital experiences.",
  stats: [
    { label: "Years Experience", value: "02+" },
    { label: "Projects Completed", value: "10+" },
    { label: "Open Source", value: "02" },
    { label: "Happy Clients", value: "100%" },
  ],
  socials: [
    { name: "Facebook", url: "https://facebook.com/tanvu.imon", icon: "Facebook" },
    { name: "Instagram", url: "https://www.instagram.com/nyxora_tanvu/", icon: "Instagram" },
    { name: "GitHub", url: "https://github.com/dev-tanvu", icon: "Github" },
    { name: "LinkedIn", url: "https://linkedin.com/in/tanvir-almas", icon: "Linkedin" },
  ],
  snapshot: {
    title: "Quick Snapshot",
    description: "A quick look at my core expertise and the technologies I use to build premium digital products.",
    tech: ["Next.js", "TypeScript", "Tailwind CSS", "Framer Motion", "Node.js", "PostgreSQL"],
  },
  projects: [
    {
      name: "Health",
